...
MODEL_PATH = "InceptionV3_clothing_attribute_model_final.keras"
IMG_SIZE = (299, 299)
BATCH_SIZE = 32
...
# --- Print Detailed Report per Label ---
...
ax.set_title("Clothing Attribute Recognition Performance (InceptionV3)")
ax.set_xticks(x)
